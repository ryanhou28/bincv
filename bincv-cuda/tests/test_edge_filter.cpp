...
int main() {
    ...
    cv::Mat refEdges(height, width, CV_8UC1, cv::Scalar(0));
    ...
    bincv::edgeFilter8b(input.data, refEdges.data, width, height, threshold);
    ...
    cv::Mat normRefEdges(height, width, CV_8UC1, cv::Scalar(0));
    ...
    bincv::util::norm_1b_to_uint8(refEdges.data, normRefEdges.data, width, height);
    ...
    bincv::util::save_test_image("edges.png", normRefEdges.data, width, height);
    std::cout << "Saved output image: horizontal_edges.png" << std::endl;
    std::cout << "Saved output image: vertical_edges.png" << std::endl;
    std::cout << "Saved output image: edges.png" << std::endl;
