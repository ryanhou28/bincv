...
//
// Roughly a third of this library is invisible to every x86 build -- the tap
// batching, the lane accumulator, ops/fast.hpp's NEON mask, ops/pack.hpp's bit-weight
