...
#include "binMat.hpp"
#include "impl/kernel_util.hpp"   // transpose8x8, quantScale
...
public:
    ...
    /// @brief Default row-stride alignment: word granularity. See BinMat.
    ...
    /// granularity with no padding. Opt-in larger alignment applies
    ...
    // copy/move already implement (copy means deep copy, wrapped or not) and
    ...
    /// how a mutable matrix hands a plane to a read-only kernel.
    ...
    //
    // THE VALUE MAPPING IS FIXED AND DELIBERATELY ASYMMETRIC:
    //
