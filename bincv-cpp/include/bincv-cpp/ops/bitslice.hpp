...
///
/// Skip that and padding bits past `width` are left set, which is the
...
/// around -- see the file header. Nothing is reduced across lanes.
...
inline void applyMajority3(BinMatConstView<WordType> a, BinMatConstView<WordType> b,
    ...
    for (size_t y = 0; y < dst.height; ++y) {
        ...
        // has its neighbours' live pixels there -- cannot leave majority
