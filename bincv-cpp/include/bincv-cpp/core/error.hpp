...
/// @file error.hpp
/// @brief The project's single error policy (ARCHITECTURE 5.3).
///
...
///       disabled (ARCHITECTURE 2), and a library that can only report errors by
...
///       belongs in BINCV_ASSERT; see ARCHITECTURE 5.3.
#if BINCV_EXCEPTIONS_ENABLED
