// T2.2 logic kernels versus OpenCV, on the same binary content.
//
...
///        proves bit-exactness over the whole T2.1 matrix, and this is the guard
...
int main(int argc, char* argv[]) {
    ...
    // The two sizes T2.2 asks for, a third that is DRAM-resident on one side and
